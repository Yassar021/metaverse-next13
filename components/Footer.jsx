...
const Footer = () => (
  <motion.footer variants={footerVariants} initial="hidden" whileInView="show" className={`${styles.padding} p-8 relative`}>
    ...
    <div className={`${styles.innerWidth} mx-auto flex flex-col gap-8`}>
      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <p className="font-normal text-[14px] text-white opacity-50">Copyright © 203 Metaversus. All rights reserved.</p>
